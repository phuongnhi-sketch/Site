...
export const SiteListView = {
    render: async () => {
        ...
        // Define global actions for this view
        window.setFilter = (key, val) => {
            window.siteFilters[key] = val;
        ...
        return `
            <div class="animate-fade-in">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:2.5rem">
                    <h1 style="display:flex; align-items:center; gap:10px">📍 Danh sách hồ sơ</h1>
                ...
                <div class="glass" style="padding:0; border-radius:24px; overflow:hidden">
                    <table class="data-table">
                        <thead>
                            <tr>
                                <th style="width:40px; padding-left:1.5rem"><input type="checkbox" onclick="window.toggleAll(this)" style="width:18px; height:18px; cursor:pointer"></th>
                            ...
                            ${sites.map(s => {
                                ...
                                return `
                                    <tr>
                                        ...
                                        <td>
                                            <strong>${sName}</strong> 
                                            ${s.v2_data ? '<span style="font-size:0.6rem; background:var(--accent-blue); color:white; padding:2px 4px; border-radius:4px; margin-left:4px">V2</span>' : ''}
                                        </td>
                                        ...
                                        <td>
                                            ${displayData.f3 ? `
                                                <div style="text-align:center">
                                                    <a href="${displayData.f3}" target="_blank" style="color:var(--accent-blue); text-decoration:none; font-size:0.8rem">
                                                        📍 Xem<br>Map
                                                    </a>
                                                </div>
                                            ` : '---'}
